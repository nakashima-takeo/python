...
class CanvasUI(Frame):
    ...
    def create_ui(self):
        ...
        Button(delete_frame, text = "delete small",
         command=lambda : self.draw("delete small")).pack(side=LEFT)

        Button(delete_frame, text = "delete big",
         command=lambda : self.draw("delete big")).pack(side=LEFT)
    ...
    def draw(self, choice):
        ...
        elif choice == "delete small":
            self.canvas.delete("small")

        elif choice == "delete big":
            self.canvas.delete("big")
