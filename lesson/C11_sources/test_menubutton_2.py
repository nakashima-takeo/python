from tkinter import Tk, Frame, Canvas, Button, Menu, Menubutton, BooleanVar, StringVar

class TestMenubutton(Menubutton):
    ...
    def create_menu(self):
        ...
        # Create a main menu
        # put inside the menu of test_menu_2.py
...
def main():
    ...
    test_menubutton = TestMenubutton(frame)
    test_menubutton.pack()
